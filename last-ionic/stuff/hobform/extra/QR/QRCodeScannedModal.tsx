...
import { QRCodeScannedModalProps } from './types'
//import closeSound from "../sounds/close.wav";
import { reloadOutline } from "ionicons/icons"
import React from "react"

const QRCodeScannedModal: React.FC<QRCodeScannedModalProps> = ( {dismiss, code, set, scan} ) => {
...
export default React.memo(QRCodeScannedModal)