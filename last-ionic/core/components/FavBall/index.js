 ...
 */
const FavBall = ({ show = true, style = {}, onClick = () => { } }) => {
    ...
    return (_jsx(IonFab, { style: fabStyles, vertical: vertical, horizontal: "end", slot: "fixed", children: _jsx(IonFabButton, { className: "mapboxgl-ctrl-geolocate fade-in-5", color: color, onClick: handleClick, children: _jsx(IonIcon, { className: iconClass, icon: icon }, "icon") }) }));
};
